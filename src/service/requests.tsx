                        ...
                        .then(async (response: any) => {
                          ...
                          aux.method = response.data.method
                            ...
                            await apiPADA
                                ...
                                .then((response: any) => {
                                    aux.dosage = response.data.dosage
                                    aux.frequency = response.data.frequency
                                    aux.startTreatment = response.data.startTreatment
                                    aux.endTreatment = response.data.endTreatment
                                });
                        });
